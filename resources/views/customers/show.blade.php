            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="section-heading">
                  ...
                  <h2>Book Appointment for Customer</h2>
                </div>
              </div>
...
<div class="form-group">
  ...
  <input name="names" id="names" placeholder="Enter Your Names" readonly class="form-control"  type="text" value="{{ $customer->CustomerName }}">
    </div>
...
<div class="form-group">
  <label class="col-md-4 control-label" >Phone Number</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon" style="width: 3em;"><i class="glyphicon glyphicon-user"></i></span>
  <input name="phone" placeholder="Enter Your Phone Number" class="form-control" readonly type="text" value="{{ $customer->CustomerPhoneNumber }}">
    </div>
...
<div class="form-group">
  <label class="col-md-4 control-label" >Plate Number</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon" style="width: 3em;"><i class="glyphicon glyphicon-user"></i></span>
  <input name="plateNumber" placeholder="Enter Your Plate Number" readonly class="form-control" value="{{ $customer->PlateNumber }}"  type="text">
...
<input type="hidden" name="RED" value="inside">
...
<!-- Text input-->
  ...
  <input name="email" placeholder="E-Mail Address" readonly class="form-control" value="{{ $customer->email }}"  type="text">
    </div>
