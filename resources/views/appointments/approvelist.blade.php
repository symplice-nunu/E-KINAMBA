...
<input type="checkbox" id="nav-toggle">
   ...
   <div class="container">
   <div class="pull-left">
                <h2>E-Kinamba Customers Approved Appointment List</h2>
    </div> <br>
   ...
   <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                ...
                <a class="btn btn-primary" href="{{ url('generate-approved-appointments-pdf') }}"><span class="las la-download"></span>Download</a>
