...
<input type="checkbox" id="nav-toggle">
   ...
   <div class="container">
    ...
    <form action="{{ route('cleaner.update',$cleaner->id) }}" method="POST">
    	@csrf
        @method('PUT')
		    ...
		    <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            ...
		            <input type="text" name="Name" value="{{ $cleaner->Name }}" class="form-control CustomerLabel" placeholder="Customer Name">
		        </div>
		    </div>
		    <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            <strong>Phone</strong>
		            <input type="text" name="Phone" value="{{ $cleaner->Phone }}" class="form-control CustomerLabel" placeholder="Customer Address">
		        </div>
		    </div>
		    <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            <strong>Address</strong>
		            <input type="text" name="Address" value="{{ $cleaner->Address }}" class="form-control CustomerLabel" placeholder="Customer Phone Number">
		        </div>
		    </div>
